...
export class SettingController {
  ...
  async getLanguageCoverageList(
    ...
    try {
      ...
      const data: any = await this.settingService.languageCoverage(languageCoverageData,appLanguage);
      if (data && data != null && data.success===true) {
        ...
        this.responseService.sendBadRequest(res,data.info.coverageArr,data.message);
      }
    } catch (error) {
      this.logger.error(
